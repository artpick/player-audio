...
#ifndef BUTTON_VISUALISATION_H
#define BUTTON_VISUALISATION_H
...
class ButtonVisualisation
{
private :

	InterfaceGraphiqueButton visualisationButton;
...
bool drawButton(SDL_Surface *fondImage);
	...
	// Fonction accés etc...
void activityVisualisation(SDL_Event* event);
};

#endif //BUTTON_VISUALISATION